...
echo_and_run cd "/home/wxd/muti_uls_lidar_ws/src/arbotix_ros/arbotix_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/wxd/muti_uls_lidar_ws/src/arbotix_ros/arbotix_python/setup.py" \
    egg_info --egg-base /home/wxd/muti_uls_lidar_ws/build/arbotix_ros/arbotix_python \
    build --build-base "/home/wxd/muti_uls_lidar_ws/build/arbotix_ros/arbotix_python" \
    install \
    --root="${DESTDIR-/}" \
